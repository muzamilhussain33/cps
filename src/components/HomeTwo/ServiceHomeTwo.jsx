                            ...
                            <Swiper {...swiperOptions} className="services-carousel-two">
                                ...
                                <SwiperSlide className="service-block-two">
                                    <div className="inner-box">
                                        ...
                                        <h6 className="title">
                                            <Link  to="/service-details">Website</Link >
                                        </h6>
                                    </div>
                                </SwiperSlide>
                                ...
                                <SwiperSlide className="service-block-two">
                                    <div className="inner-box">
                                        ...
                                        <h6 className="title">
                                            <Link  to="/service-details">iOS</Link >
                                        </h6>
                                    </div>
                                </SwiperSlide>
                                ...
                                <SwiperSlide className="service-block-two">
                                    <div className="inner-box">
                                        ...
                                        <h6 className="title">
                                            <Link  to="/service-details">Android</Link >
                                        </h6>
                                    </div>
                                </SwiperSlide>
                                ...
                                <SwiperSlide className="service-block-two">
                                    <div className="inner-box">
                                        ...
                                        <h6 className="title">
                                            <Link  to="/service-details">IOT</Link >
                                        </h6>
                                    </div>
                                </SwiperSlide>
                                ...
                                <SwiperSlide className="service-block-two">
                                    <div className="inner-box">
                                        ...
                                        <h6 className="title">
                                            <Link  to="/service-details">Television</Link >
                                        </h6>
                                    </div>
                                </SwiperSlide>
                            </Swiper>
