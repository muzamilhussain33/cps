                ...
                <table className="table table-striped table-bordered tbl-shopping-cart">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="product-name"><Link  to="/products-details">Headphone</Link > x 2</td>
                    ...
                    <tr>
                      ...
                      <td className="product-name"><Link  to="/products-details">Lagage</Link > x 3</td>
                    ...
                    <tr>
                      ...
                      <td className="product-name"><Link  to="/products-details">Watch</Link > x 1</td>
