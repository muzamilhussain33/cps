...
import TestimonialImage1 from '../../assets/images/resource/testi-thumb-1.jpg';
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-xl-6 product-info">
                            <div className="product-details__top">
                                <h3 className="product-details__title">Smart Watch<span>$76.00</span> </h3>
                            </div>
                            ...
                            <div className="tabs-content">
								...
								<div className="row clearfix">
									<div className="col-lg-6 col-md-6 col-sm-12 comment-column">
										<div className="single-comment-box">
											<div className="inner-box">
												<figure className="comment-thumb"><img src={TestimonialImage1} alt="Product Thumb" /></figure>
												<div className="inner">
									...
									<div className="col-lg-6 col-md-6 col-sm-12 comment-column">
										<div className="single-comment-box">
											<div className="inner-box">
												<figure className="comment-thumb"><img src={TestimonialImage2} alt="Product Thumb" /></figure>
												<div className="inner">
													<ul className="rating clearfix">
														<li><i className="fas fa-star"></i></li>
														<li><i className="fas fa-star"></i></li>
